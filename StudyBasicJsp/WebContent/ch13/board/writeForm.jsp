...
<form method="post" action="writePro.jsp"  
	...
	<table>
		<tr>
			<td align="right" colspan="2" bgcolor="<%=value_c %>" class="top_text">
		...
		<tr>
			...
			<td width="330" align="left">
				...
				name="email" style="ime-mode:inactive;">
			</td>
		</tr>
		<tr  height="227">
			<td width="70"bgcolor="<%=value_c %>" align="center">내용</td>
			<td width="330" align="left"><textarea name="content" rows="13" cols="40" style="ime-mode:active;"></textarea></td>
		</tr>
		<tr>
