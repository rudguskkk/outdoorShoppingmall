...
%>
	<br> <font size="3"><b><%=book_kindName%> 분류의 신간목록: 
	<a href="list.jsp?book_kind=<%=bookLists[0].getBook_kind()%>" style="color:darkblue; font-size:18px;">더보기</a>
	</b></font><br><br>
	<%
		...
		<table class="list_table">
			<tr height="30" bgcolor="<%=value_c %>">
				<td rowspan="4" width="100">
					...
					<img src="../../imageFile/<%=bookLists[j].getBook_image() %>" border="0"
			...
			<tr height="30" bgcolor="<%=value_c %>">
				<td width="350">출판사 : <%=bookLists[j].getPublishing_com() %>
				</td>
			</tr>
			<tr height="30" bgcolor="<%=value_c %>">
				<td width="350">저자 : <%=bookLists[j].getAuthor() %>
				</td>
			</tr>
			<tr height="30" bgcolor="<%=value_c %>">
				<td width="350">정가 
