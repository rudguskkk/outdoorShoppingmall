...
%>
		<tr>
			<td colspan="5" align="right" style="padding-right:55px">
				<b><font color="blue" size="3">총구매금액 : <%=NumberFormat.getInstance().format(total) %></font></b>			
			</td>
		</tr>
	</table>
</form>
	...
	<table>
		...
		<tr>
			...
			<td width="400" align="left">
				<select name="accountList" id="accountList">
					...
					%>
					<option value="<%=accountList %>"><%=accountList%>
					</option>
					<%} %>
				</select>
			</td>
		...
		<tr>
			<td colspan="2" align="center" bgcolor="<%=value_c %>">
				<input type="button" value="결제계좌등록"
