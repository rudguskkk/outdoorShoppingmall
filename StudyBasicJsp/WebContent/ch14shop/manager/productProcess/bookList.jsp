...
<tr>
	<td align="center" bgcolor="<%=value_c %>">
		<a href="bookRegisterForm.jsp" style="float:right;">책등록</a>
		<a href="../managerMain.jsp" style="float:left;">관리자 메인으로</a> &nbsp;
...
<table>
	<tr height="30" bgcolor="<%=value_c %>">
		...
		<td align="center" width="40">책분류</td>
		...
		<td align="center" width="70">출판일</td>
...
<%
	for(int i = 0; i < bookList.size(); i++){
		...
		if(book.getBook_kind().equals("100")){
			book_kindName = "문학";
		} else if(book.getBook_kind().equals("200")){
			book_kindName = "외국어";
		} else if(book.getBook_kind().equals("300")){
			book_kindName = "컴퓨터";
		} else if(book.getBook_kind().equals("400")){
			book_kindName = "레시피";
		} else if(book.getBook_kind().equals("500")){
			book_kindName = "여행";
		}
...
%>
	<tr height="30">
		...
		<td width="40"><%=book_kindName %></td>
		<td width="100"><%=book.getBook_title() %></td>
		<td width="50"><%=book.getBook_price() %></td>
		<td width="50">
		...
		<td width="70"><%=book.getPublishing_date() %></td>
		...
		<td width="50">
			...
			book_kind=<%=book.getBook_kind() %>">수정</a>
		</td>
		<td width="50">
			<a href="bookDeleteForm.jsp?book_id=<%=book.getBook_id()%>&
			book_kind=<%=book.getBook_kind() %>">삭제</a>
		</td>
	</tr>
<%} %>
</table>
